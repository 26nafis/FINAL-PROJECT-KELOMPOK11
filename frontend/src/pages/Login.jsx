...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Admin diarahkan ke dashboard admin, customer ke halaman yang
      // sebelumnya mereka tuju (atau home kalau langsung buka /login).
      if (user.role === 'admin') {
    ...
    <div className="min-h-screen bg-[#080b12] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white">Gemini Commerce</h1>
